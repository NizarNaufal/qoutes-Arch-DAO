...
import id.nizardev.qoutes.utils.ioThread
...
abstract class RWQuotesDatabase : RoomDatabase() {
  ...
  companion object {
      ...
      if (INSTANCE == null) {
        synchronized(RWQuotesDatabase::class) {
          INSTANCE = Room.databaseBuilder(context,
              RWQuotesDatabase::class.java, "quotes_database.db")
    ...
    val PREPOPULATE_DATA = listOf(
        ...
        "Nizar Naufal", "20/12/2020"),
        Quote(2, "First, solve the problem. Then, write the code.", "Nizar Naufal", "20/12/2020")
    )
  }
