...
open class QuoteDaoTest : DatabaseTest() {
  ...
  @Test
  fun insertQuoteTest() {
    val quote = Quote(id = 1, text = "Hello World", author = "Nizar Naufal", date = "20/12/2020")
  ...
  @Test
  fun updateQuoteTest() {
    var quote = Quote(id = 1, text = "Hello World", author = "Nizar Naufal", date = "20/12/2020")
    appDatabase.quotesDao().insertQuote(quote)
    quote.author = "Nizar Naufal"
